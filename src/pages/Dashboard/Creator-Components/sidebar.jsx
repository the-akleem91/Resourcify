      ...
      >
        <VStack align="start" direction={direction} spacing={{ base: 2, md: 4 }}>
          ...
          <HStack
            ...
            spacing={4}
          >
            <Icon as={BiSolidFoodMenu} boxSize={iconSize} />
            <NavLink cursor="pointer" to='/courses'>Courses</NavLink>
          </HStack>
          <HStack
            _hover={{ bg: '#E5B673', borderRight: { md: "5px solid #D88511" }, color: "gray.100" }}
            width="full"
            ...
            spacing={4}
          >
            <Icon as={SiGoogleanalytics} boxSize={iconSize} />
            <NavLink cursor="pointer" to='/analytics'>Analytics</NavLink>
          </HStack>
        </VStack>
      </Box>
    </Box>
